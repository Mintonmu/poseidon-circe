...
void InterserverServletContainer::insert_servlet(boost::uint16_t message_id, InterserverServletCallback callback){
	PROFILE_ME;
	...
	m_map.emplace(message_id, boost::make_shared<InterserverServletCallback>(STD_MOVE_IDN(callback)));
}
